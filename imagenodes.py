...
NODE_DISPLAY_NAME_MAPPINGS = {
    "Image Crop By Mask": "按蒙版裁剪图像",
    "Image Paste By Mask": "按蒙版粘贴图像",
    "Image Crop By Ratio": "按比例裁剪图像",
    "Image Match Crop To Mask": "图像匹配裁剪到蒙版",
    "Image Crop By Shape": "按形状裁剪图像",
    "Image Paste By Shape": "按形状粘贴图像",
    "PasteImageIntoMaskRect": "粘贴图像到蒙版矩形",
    "image concat mask": "图像拼接蒙版",
    "image resize": "图像调整大小",
    "ImageResizeProportional": "按比例调整图像大小",
    "ImageResizeToReferencePixels": "调整到参考像素大小"
} 